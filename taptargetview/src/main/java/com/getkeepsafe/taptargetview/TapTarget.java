...
public class TapTarget {
   ...
   * <b>Note:</b> This is currently experimental, use at your own risk
   */
  public static TapTarget forToolbarOverflow(Toolbar toolbar, CharSequence title, @Nullable CharSequence description, @Nullable CharSequence skipText) {
   ...
   * <b>Note:</b> This is currently experimental, use at your own risk
   */
  public static TapTarget forToolbarOverflow(android.widget.Toolbar toolbar, CharSequence title, @Nullable CharSequence description, @Nullable CharSequence skipText) {
    return new ToolbarTapTarget(toolbar, false, title, description, skipText);
  }
  ...
  /** Return a tap target for the navigation button (back, up, etc) from the given toolbar **/
  public static TapTarget forToolbarNavigationIcon(Toolbar toolbar, CharSequence title, @Nullable CharSequence description, @Nullable CharSequence skipText) {
  ...
  /** Return a tap target for the navigation button (back, up, etc) from the given toolbar **/
  public static TapTarget forToolbarNavigationIcon(android.widget.Toolbar toolbar, CharSequence title, @Nullable CharSequence description, @Nullable CharSequence skipText) {
    return new ToolbarTapTarget(toolbar, true, title, description, skipText);
  }

  /** Return a tap target for the menu item from the given toolbar **/
  public static TapTarget forToolbarMenuItem(Toolbar toolbar, @IdRes int menuItemId, CharSequence title) {
    return forToolbarMenuItem(toolbar, menuItemId, title, null, null);
  }

  /** Return a tap target for the menu item from the given toolbar **/
  public static TapTarget forToolbarMenuItem(Toolbar toolbar, @IdRes int menuItemId, CharSequence title, @Nullable CharSequence description,
                                             @Nullable CharSequence skipText) {
    return new ToolbarTapTarget(toolbar, menuItemId, title, description, skipText);
  }

  /** Return a tap target for the menu item from the given toolbar **/
  public static TapTarget forToolbarMenuItem(android.widget.Toolbar toolbar, @IdRes int menuItemId, CharSequence title) {
    return forToolbarMenuItem(toolbar, menuItemId, title, null, null);
  }

  /** Return a tap target for the menu item from the given toolbar **/
  public static TapTarget forToolbarMenuItem(android.widget.Toolbar toolbar, @IdRes int menuItemId, CharSequence title, @Nullable CharSequence description,
                                             @Nullable CharSequence skipText) {
    return new ToolbarTapTarget(toolbar, menuItemId, title, description, skipText);
  }
  ...
  /** Specify the color value for the skip text **/
  // TODO(Hilal): In v2, this API should be cleaned up / torched
  ...
  /** Specify the typeface for skip text **/
  public TapTarget skipTypeface(Typeface skipTypeface) {
    if (skipTypeface == null) throw  new IllegalArgumentException("Cannot use a null typeface");
  ...
  /** Specify the text size for the skip in SP **/
  ...
  /** Specify the alpha value [0.0, 1.0] of the skip text **/
  public TapTarget skipTextAlpha(float skipTextAlpha) {
    if (skipTextAlpha < 0 || skipTextAlpha > 1f) {
      throw new IllegalArgumentException("Given an invalid alpha value: " + skipTextAlpha);
    }
    this.skipTextAlpha = skipTextAlpha;
    return this;
  }
